...
\begin{document}
	...
	% 中文摘要
	% -----------------------------------------------%
	%\addcontentsline{toc}{abstractcn}{tableofcontents}
	\phantomsection                %% 解决目录中超链接地址错误问题
	\addcontentsline{toc}{section}{\hspace*{-2.5em}{摘要}} %%增加摘要至目录且与第一章对齐
	...
	% 英文摘要
	% -----------------------------------------------%
	%\addcontentsline{toc}{abstracten}{tableofcontents}
	\phantomsection                %% 解决目录中超链接地址错误问题
	\addcontentsline{toc}{section}{\hspace*{-2.5em}{ABSTRACT}}
	...
	%增加目的到目录索引
	\phantomsection                %% 解决目录中超链接地址错误问题
	\addcontentsline{toc}{section}{\hspace*{-2.5em}{目录}} %%\hspace*{-2.5em}主要解决没有序号目录与章节对齐问题，临时设置
	{
	...
	\fancyhf[RH]{\songti \zihao{5} \leftmark} % 设置所有（奇数和偶数）右侧页眉
	...
	\addcontentsline{toc}{section}{\hspace*{-2.5em}{参考文献}} % 由于参考文献不是section，这句把参考文献加入目录
